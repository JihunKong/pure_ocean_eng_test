...
| 36 | continue | 계속하다, 계속하다 |
| 37 | move forward | 전진하다 |
| 38 | society | (복잡한) 집단(국가/사회) |
| 39 | parameter | (경계(제재 지점) 범주 |
| 40 | comfort | 안락, 위안 |
| 41 | convenience | 편리, 편의 |
| 42 | enough | 부족없이(형용사) 만족며 |
| 43 | be tempted to | ~하고자 유혹받다 |
| 44 | require | 필요(요구)하다, 필요로 하다 |
| 45 | successful | 성공적인 |
| 46 | success | 성공, 성과 |
| 47 | desire | 욕구, 강망, 바램 |
| 48 | patience | 인내심, 인내력, 견디심 |
| 49 | develop | 발전(개발)하다(시키다) |
| 50 | achieve | 달성하다, 성취하다 |
| 51 | pray | 비(기도)하다 |
| 52 | impatience | 성급함, 조급, 참지, 조바심 |
| 53 | brick | 벽돌 |
| 54 | accelerator | (자동차의) 액셀레이터이, 가속장치 |
| 55 | vehicle | 차량, 탱고, 운송 수단 |
| 56 | forward | 앞으로 |
| 57 | barrier | 장벽, 약해물 |
| 58 | be worth ~ing | ~할 가지가 있다 |
| 59 | pursuit | 추구, 추적, 추구 |
| 60 | concept | 개념 |
| 61 | possess | 소유(소지)하(옇)다 |
| 62 | enable | ~할 수 있게 하다 |
| 63 | operate | 작동(기동)하다, 가동(가다) |
| 64 | autonomously | 자율적으로, 독자적으로 |
| 65 | distant | 먼, 멀리히 있는, 동떨어진(멀다) |
| 66 | seem | ~처럼 보이다, 인 것 같다 |
| 67 | medicine | 의약, 의술, 의학 |
| 68 | decode | 해석(란) |
| 69 | approach | 다가가다(접근) |
| 70 | unique | 유일무이한, 특별한 |
| 71 | tool | 도구, 연장, 공구 |
| 72 | possess | 소유(소지)하(옇)다 |
| 73 | advance | 전진, 전개 |
| 74 | device | 장치(기구) |
| 75 | monitor | 모니터, 감시하, 감시 장치, 관찰하다 |
| 76 | specific | 구체적인, 명백한, 분명한 |
| 77 | appropriate | 적절한 |
| 78 | refine | 정제(세련)하다, 개선(개량)하다 |
| 79 | overrate | 과대평(과다) |
| 80 | impact | 영향, 충격, 요충하다 |
| 81 | absorb | 흡수(이(빨아)들여다) |
| 82 | invisible | 보이지 않는, 볼 수 없는 |
| 83 | implement | 시행하다 |
| 84 | fundamental | 근본(본질)적인 |
| 85 | neat | 아담하다(깨끗한(개끗한) |
| 86 | infant | 유아, 아기 |
| 87 | function | 기능, 역알, 직부 |
| 88 | substitute | 대신자, 대체품, 대용품 |
| 89 | implication | 함축, 암시, 함축(의미) |
| 90 | management | 경영(관리/처리) |
| 91 | overlook | 간과하다, 못 보데하다 |
| 92 | society | 사회 |
| 93 | empathy | 감정이입, 공감 |
| 94 | emphasize | 강조하다 |
| 95 | negotiate | 협상(교섭)하다 |
| 96 | specify | 구체화하다 |
| 97 | perspective | 관점, 시각, 견해잠 |
| 98 | concern | 우려(걱정), 염려을 하세다 |
| 99 | compassion | 연민, 동정심 |
| 100 | consultant | 상담가, 자문 위원, 전문의들 |
| 101 | argue | 인증을 하다, 다투다 |
| 102 | translate | 번역(통역)하다, 옮기다 |
| 103 | conduct | 수행하다 |
| 104 | research | 연구, (연구)조사 |
| 105 | seek | 찾다, 구하다, 추구하다 |
| 106 | fulfill | 성취하다, 수행하다, 충족하다 |
| 107 | take into account | 고려하다, 참작하다, 정산에 넣다 |
| 108 | cognitive | 인지(인식)의 |
| 109 | prevalent | 널리(만연)하게 퍼져 있는 |
| 110 | accessible | 접근이(갈수가)히 가능한 |
| 111 | obligation | 의무 |
| 112 | probably | 아마 |
| 113 | pressure | 압력, 압박 |
| 114 | instantly | 즉시, 금방 |
| 115 | interaction | 상호 작용, 상호의 영향 |
| 116 | behavior | 행동, 기동, 행위, 품행, 태도 |
| 117 | aggressive | 공격적인 |
| 118 | happen | 발생하다, 일어나다 |
| 119 | consumption | 소비(소모(양))|
| 120 | protein | 단백질 |
| 121 | source | 원천, 근원 |
| 122 | category | 범주 |
| 123 | imagery | 심상(이미지) |
...
| 126 | measure | (수치의) 인척 |
| 127 | behavioral | 행동의, 행동을 관련 |
| 128 | medicine | 의학, 의술, 의료, 약, 약품 |
| 129 | positive | 공정적인 |
| 130 | technique | 기법, 기술 |
| 131 | alongside | ~옆에, 나란히, ~함꼐, ~와 동시에 |
| 132 | modification | 소개(변경) |
| 133 | tactic | 전략(작전) |
| 134 | mental | 정신의, 마음의 |
| 135 | effective | 효과적인 |
| 136 | reinforce | 강화(다), 보강하다, 증강(초화)하다 |
| 137 | strongly | 강력하게 |
| 138 | emotion | 감정, 정서 |
| 139 | foundational | 기본적, 기초적인 |
| 140 | regulation | 규칙, 규제, 통제, 단속 |
| 141 | development | 발전, 성장, 개발 |
| 142 | directive | 지시(명령) |
| 143 | guidance | 지도(안내) |
| 144 | beneficial | 이로운, 유익힌 |
| 145 | adolescent | 청소년 |
| 146 | autonomy | 자치권 |
| 147 | crisis | 위기, 회기의 급변 |
| 148 | parental | 부모의, 어버이(닮아니넌) |
| 149 | suitable | 적합한, 알맞은, 알맞은 |
| 150 | indirect | 간접적인, 우회적인 |
| 151 | as well as | ~뿐 아니라(서도) |
| 152 | capability | 능력, 역량 |
| 153 | misguide | 길을 아르침, 잘못 인도(시키다) |
| 154 | accomplish | 완수하다, 성취하다, 해내다 |
| 155 | repetitive | 지루한, 반복적인 |
| 156 | vertical | 수직의, 세로의 |
| 157 | lower | 낮추다, 낮추다 |
| 158 | struggle to | ~하려고 간신하에 애쓰다 |
| 159 | complete | 완벽하다, 온전하다, 완전한, 완벽한 |
| 160 | connection | 연결, 관속, 관련(안전써) |
| 161 | rapid | 빠븐(속도가) |
| 162 | alignment | 가치림이, 수직(무섞혀) |
| 163 | rotation | 회전, 순회, 적근, 교대 |
| 164 | axis | 축, 축선, 중심선 |
| 165 | accomplish | 완수하다, 성취하다, 해내다 |
| 166 | successfully | 성공적으로 |
| 167 | impose | 도화(시키)하다, 강요하다, 부과하다 |
| 168 | describe | 말래(묘사)하다니, 묘사하다 |
| 169 | physical | 육체적, 신체의 |
| 170 | minimize | 최소화하다, 축소하다 |
| 171 | potential | 잠재력, 가능성 |
| 172 | injury | 부상, 상세, 피해 |
| 173 | explore | 탐험(탐사/답사)하다 |
| 174 | imply | 암시(시사)하다, 의미하다 |
| 175 | supposedly | 추정상, 여터 |
| 176 | commercial | 상업의, 상업적인 |
| 177 | considerable | 상당한, 많은 |
| 178 | audience | 청중(들이) |
| 179 | user | 가격, 만장, 잠잠, 비변, 사용(인물) |
| 180 | comprise | 구성하다(이루어지다) |
| 181 | comparison | 변교, 견이요는, 대비(치) |
| 182 | correspond with | ~와 일치하다 |
| 183 | embrace | 저안다, 포용하다 |
| 184 | seemingly | 외견장으로, 겉보기/히는, 보이히다 |
| 185 | prejudice | 편견, 곤전잠 견깨, 선입견 (을) 가지다 |
| 186 | legitimate | 정당한, 타당한, 적법인, 합법적인 |
| 187 | contemporary | 동시대의, 반대의, 당대의 |
| 188 | reflection | 제 5의지, 반사, 반영, 반영 |
| 189 | reward | 보상, 현장끄, 보상금, 사래몰 |
| 190 | process | 과정(예상) |
| 191 | uncertain | 확실진 알는 일 요도는, 불확실한 |
| 192 | phrase | 구, 구혁, 문장구 |
| 193 | curiosity | 호기심, 진미한 것 |
| 194 | lead to | ~로 이어지다 |
| 195 | investigator | 수사관, 조사관 |
| 196 | influence | 영향, 영향력 |
| 197 | composition | 구성 요소들, 구성, 작품, 작곡, 작명 |
| 198 | in the case of | ~에 관해서는, ~에 관해세 생계하면 |
| 199 | focus on | ~에 중점하다, 초호울 맞추다 |
| 200 | decrease | 줄어들다(감소)하다, 줇다 |
| 201 | pattern | 양식, 패턴 |
| 202 | significant | 중요보다(인), 의미(상당한) |
| 203 | repository | 저장질(보관소) |
| 204 | knowledge | 지식, 압고 있음 |
| 205 | potential | 잠재적인 |
| 206 | considerable | 상당한, 많은 |
| 207 | correspond with | ~와 일치하다 |
| 208 | cultivate | 경작하다, 얻다, 개배하다 |
| 209 | reality | 현실(실제 생왕) |
| 210 | adolescent | 청소년 |
| 211 | autonomous | 자주적인, 자치적 |
| 212 | contemporary | 동시대의 |
| 213 | legitimate | 정당한, 타당한, 적법인 |
| 214 | regulation | 규칙, 규제, 통제, 단속 |
